...
% Script: LM_Dynamics_Orbit1.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Este código apresenta a simulação da primeira órbita lunar considerada (aproximada por inspeção da referência principal citada anteriormente) para verificação da dinâmica do sistema do módulo lunar.
...
Tf=3510; Tf2=3400; Tf1=3100; Tf0=2880; rr0=1837.4;
...
[t3,y3] = ode45(@(t,x)PDFp1(t,x,Tf0,Tf1,Tf),[7.37+Tf0 Tf1],y2(end,:)');                                                              
% Powered Descent Phase - part 2 
[t4,y4] = ode45(@(t,x)PDFp2(t,x,Tf0,Tf1,Tf2,Tf),[Tf1 Tf2],y3(end,:)');                                                              
% Powered Descent Phase - part 3
[t5,y5] = ode45(@(t,x)PDFp3(t,x,Tf0,Tf2,Tf),[Tf2 Tf],y4(end,:)');                                                              
